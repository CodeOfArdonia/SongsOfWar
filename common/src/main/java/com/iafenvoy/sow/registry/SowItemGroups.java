...
public final class SowItemGroups {
    ...
    public static final RegistrySupplier<ItemGroup> WEAPONS = REGISTRY.register("weapons", () -> CreativeTabRegistry.create(Text.translatable("itemGroup." + SongsOfWar.MOD_ID + ".weapons"), () -> GlintManager.RED.apply(new ItemStack(SowWeapons.SWORD_INGRESSSUS.get()), true)));
