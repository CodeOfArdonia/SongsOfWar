...
public class SowClientConfig extends FileConfigContainer {
    ...
    public SowClientConfig() {
        super(Identifier.of(SongsOfWar.MOD_ID, "sow_config_client"), "config.sow.client.title", "./config/sow/songs-of-war-client.json");
    }
    ...
    public static void processEmissiveStack(MatrixStack matrices) {
