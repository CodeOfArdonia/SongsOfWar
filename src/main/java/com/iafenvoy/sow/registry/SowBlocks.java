...
public final class SowBlocks {
    ...
    public static final DeferredBlock<SongCubeBlock> AGGRESSIUM_SONG = register("aggressium_song", () -> new SongCubeBlock(SowAbilityCategories.AGGRESSIUM), SongCubeItem::new);
    public static final DeferredBlock<SongCubeBlock> MOBILIUM_SONG = register("mobilium_song", () -> new SongCubeBlock(SowAbilityCategories.MOBILIUM), SongCubeItem::new);
    public static final DeferredBlock<SongCubeBlock> PROTISIUM_SONG = register("protisium_song", () -> new SongCubeBlock(SowAbilityCategories.PROTISIUM), SongCubeItem::new);
    public static final DeferredBlock<SongCubeBlock> SUPPORTIUM_SONG = register("supportium_song", () -> new SongCubeBlock(SowAbilityCategories.SUPPORTIUM), SongCubeItem::new);
