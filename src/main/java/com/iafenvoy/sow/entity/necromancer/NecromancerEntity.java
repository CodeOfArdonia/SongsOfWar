...
public class NecromancerEntity extends AbstractNecromancerEntity {
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(NecromancerEntity.class, EntityDataSerializers.INT);
    ...
    public ResourceLocation getTextureId() {
        return ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/necromancer/necromancer_" + this.getVariant() + ".png");
    }
}
