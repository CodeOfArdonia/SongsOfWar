...
public class BartenderEntity extends AbstractHumanEntity {
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(BartenderEntity.class, EntityDataSerializers.INT);

    public BartenderEntity(EntityType<? extends Monster> entityType, Level world) {
    ...
    public ResourceLocation getTextureId() {
        if (this.getVariant() == 2)
            return ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/human/hogtown_bartender.png");
        return ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/human/biggerton_bartender.png");
    }
}
