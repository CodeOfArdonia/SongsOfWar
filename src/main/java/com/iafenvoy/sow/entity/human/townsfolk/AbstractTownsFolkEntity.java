...
public abstract class AbstractTownsFolkEntity extends AbstractHumanEntity {
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(AbstractTownsFolkEntity.class, EntityDataSerializers.INT);

    protected AbstractTownsFolkEntity(EntityType<? extends Monster> entityType, Level world) {
    ...
    public ResourceLocation getTextureId() {
        return ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/human/townsfolk/" + this.job() + "_" + this.getVariant() + ".png");
    }
}
