...
public class CivilianEntity extends AbstractHumanEntity {
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(CivilianEntity.class, EntityDataSerializers.INT);
    ...
    public ResourceLocation getTextureId() {
        return switch (this.getVariant()) {
            case 2 -> ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/human/hogtown_civilian_1.png");
            case 3 -> ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/human/hogtown_civilian_2.png");
            default -> ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/human/biggerton_civilian.png");
        };
    }
}
