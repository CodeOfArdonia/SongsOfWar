...
public class SowZombieEntity extends AbstractZombieEntity {
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(SowZombieEntity.class, EntityDataSerializers.INT);

    public SowZombieEntity(EntityType<? extends Zombie> entityType, Level world) {
    ...
    public ResourceLocation getTextureId() {
        return ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/zombie/zombie_" + this.getVariant() + ".png");
    }
