...
public class SowStrayEntity extends AbstractZombieEntity {
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(SowStrayEntity.class, EntityDataSerializers.INT);

    public SowStrayEntity(EntityType<? extends Zombie> entityType, Level world) {
    ...
    public ResourceLocation getTextureId() {
        return ResourceLocation.tryBuild(SongsOfWar.MOD_ID, "textures/entity/zombie/stray_" + this.getVariant() + ".png");
    }
