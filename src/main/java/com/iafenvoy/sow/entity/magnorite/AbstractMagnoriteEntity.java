...
public abstract class AbstractMagnoriteEntity extends Monster implements EntityWithMarkerTextureProvider {
    protected AbstractMagnoriteEntity(EntityType<? extends Monster> entityType, Level world) {
