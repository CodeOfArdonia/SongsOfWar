...
public abstract class AbstractNetheranEntity extends Monster implements EntityWithMarkerTextureProvider {
    protected AbstractNetheranEntity(EntityType<? extends Monster> entityType, Level world) {
