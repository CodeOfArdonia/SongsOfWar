...
public abstract class AbstractFelinaEntity extends Monster implements EntityTextureProvider {
    public AbstractFelinaEntity(EntityType<? extends Monster> entityType, Level world) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new RandomStrollGoal(this, 0.65));
